import{j as t,M as i}from"./iframe-4keGAOXU.js";import{useMDXComponents as n}from"./index-CkJtS0rJ.js";import"./preload-helper-PPVm8Dsz.js";function o(s){const e={a:"a",code:"code",h1:"h1",h2:"h2",li:"li",p:"p",pre:"pre",ul:"ul",...n(),...s.components};return t.jsxs(t.Fragment,{children:[t.jsx(i,{title:"Basic Setup"}),`
...
They should be committed to your repository.`]})]})}function a(s={}){const{wrapper:e}={...n(),...s.components};return e?t.jsx(e,{...s,children:t.jsx(o,{...s})}):o(s)}export{a as default};
