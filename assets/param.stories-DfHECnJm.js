import{i as e,s as t}from"./preload-helper-xPQekRTU.js";import{t as n}from"./react-H9AhGIcj.js";import{i as r,n as i,t as a}from"./src-BWlDr63T.js";var o,s,c,l,u,d,f,p,m;e((()=>{o=t(n(),1),a(),{expect:s}=__STORYBOOK_MODULE_TEST__,c={title:`utils/defineAutoSnapshotParam`,tags:[`snapshot`]},l={parameters:i({failureThreshold:70}),loaders:[async()=>({hasImageSnapshot:await r()})],render:(e,{loaded:{hasImageSnapshot:t}})=>o.createElement(`div`,{"data-testid":`subject`},t?`unit text`:`unit test`)},u={parameters:i({failureThreshold:.3,failureThresholdType:`percent`}),loaders:[async()=>({hasImageSnapshot:await r()})],render:(e,{loaded:{hasImageSnapshot:t}})=>o.createElement(`div`,{"data-testid":`subject`},t?`unit text`:`unit test`)},d={tags:[`!snapshot`],parameters:i({failureThreshold:1}),loaders:[async()=>({hasImageSnapshot:await r()})],render:(e,{loaded:{hasImageSnapshot:t}})=>o.createElement(`div`,{"data-testid":`subject`},t?`unit text`:`unit test`),play:async({canvas:e})=>{await s(e.getByTestId(`subject`)).toMatchImageSnapshot({failureThreshold:70})}},f={parameters:i({comparisonMethod:`ssim`,diffOptions:{ssim:`bezkrovny`}}),render:()=>o.createElement(`div`,{"data-testid":`subject`},`unit test`)},p={parameters:i({failureThreshold:70,subject:`[data-testid="alt"]`}),loaders:[async()=>({hasImageSnapshot:await r()})],render:(e,{loaded:{hasImageSnapshot:t}})=>o.createElement(`div`,{"data-testid":`alt`},t?`unit text`:`unit test`)},l.parameters={...l.parameters,docs:{...l.parameters?.docs,source:{originalSource:`{
