import{a as e,n as t}from"./rolldown-runtime-DkW27tQK.js";import{t as n}from"./react-BZJXY1be.js";import{n as r,t as i}from"./src-B9ZZ7RZv.js";function a(e){return{snapshot:e}}var o,s,c,l,u,d,f,p,m;function h(){return(h=t((()=>{o=e(n(),1),i(),{expect:s}=__STORYBOOK_MODULE_TEST__,c={title:`utils/defineAutoSnapshotParam`,tags:[`snapshot`]},l={parameters:a({failureThreshold:70}),loaders:[async()=>({hasImageSnapshot:await r()})],render:(e,{loaded:{hasImageSnapshot:t}})=>o.createElement(`div`,{"data-testid":`subject`},t?`unit text`:`unit test`)},u={parameters:a({failureThreshold:.3,failureThresholdType:`percent`}),loaders:[async()=>({hasImageSnapshot:await r()})],render:(e,{loaded:{hasImageSnapshot:t}})=>o.createElement(`div`,{"data-testid":`subject`},t?`unit text`:`unit test`)},d={tags:[`!snapshot`],parameters:a({failureThreshold:1}),loaders:[async()=>({hasImageSnapshot:await r()})],render:(e,{loaded:{hasImageSnapshot:t}})=>o.createElement(`div`,{"data-testid":`subject`},t?`unit text`:`unit test`),play:async({canvas:e})=>{let t=e.getByTestId(`subject`);await s(t).toMatchImageSnapshot({failureThreshold:70})}},f={parameters:a({comparisonMethod:`ssim`,diffOptions:{ssim:`bezkrovny`}}),render:()=>o.createElement(`div`,{"data-testid":`subject`},`unit test`)},p={parameters:a({failureThreshold:70,subject:`[data-testid="alt"]`}),loaders:[async()=>({hasImageSnapshot:await r()})],render:(e,{loaded:{hasImageSnapshot:t}})=>o.createElement(`div`,{"data-testid":`alt`},t?`unit text`:`unit test`)},l.parameters={...l.parameters,docs:{...l.parameters?.docs,source:{originalSource:`{
