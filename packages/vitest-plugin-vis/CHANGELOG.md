...
- [#870](https://github.com/repobuddy/visual-testing/pull/870) [`5c2970c`](https://github.com/repobuddy/visual-testing/commit/5c2970c8f2069512dc136ca9e5edd25def39f7db) Thanks [@unional](https://github.com/unional)! - Pin `type-plus` to `8.0.0-beta.10`, exactly.
...
- [#861](https://github.com/repobuddy/visual-testing/pull/861) [`ee4464a`](https://github.com/repobuddy/visual-testing/commit/ee4464a4ef9e407d8e99c2abcf3387e0e1750b91) Thanks [@unional](https://github.com/unional)! - Depend on `type-plus` `^8.0.0-beta.10` — back on the 8.x line, as a range.
...
- [#859](https://github.com/repobuddy/visual-testing/pull/859) [`62026f5`](https://github.com/repobuddy/visual-testing/commit/62026f5bca4718b34d53495e2934f62645a20d66) Thanks [@unional](https://github.com/unional)! - Stop the `server` proxy from throwing before the vitest browser module loads.
...
- [#672](https://github.com/repobuddy/visual-testing/pull/672) [`ab4ca8a`](https://github.com/repobuddy/visual-testing/commit/ab4ca8ac669b5d50d1e4d892fa6c5927b77e7f9d) Thanks [@unional](https://github.com/unional)! - Add `projectName` to the context of `snapshotRootDir` to allow users to customize the snapshot root directory based on the project name.
  ...
  export default defineConfig({
    test: {
      name: "vpv:pw",
      browser: {
        instances: [{ browser: "chromium", name: "HD" }],
      },
    },
  });
  ```
...
- [#667](https://github.com/repobuddy/visual-testing/pull/667) [`ad87b83`](https://github.com/repobuddy/visual-testing/commit/ad87b8399a5a5d881aa030e47f4684760b1733a0) Thanks [@unional](https://github.com/unional)! - Fix retrying. Reported by @sinled.
